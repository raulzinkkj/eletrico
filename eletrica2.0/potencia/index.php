...
<head>
    ...
    <style>
        ...
        .triangle-container {
            ...
            border-bottom: 346px solid #4843d4;
            filter: drop-shadow(0 10px 15px rgba(72, 52, 212, 0.3));
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="content-overlay">
            <div class="section v-section" onclick="focusInput('p')">
                <div class="label">P</div>
                <div class="sub-label">Potência (Watts)</div>
            </div>

            <div class="horizontal-line"></div>

            <div class="bottom-row">
                <div class="section" onclick="focusInput ('v')">
                    <div class="label">E</div>
                    <div class="sub-label">Tensão (Volts)</div>
                </div>
    ...
    <div class="resultados">
        ...
        if ($stmt->rowCount() > 0) {
            ...
            echo "<div class='cel_cabecalho'>Potência</div>";
            ...
            while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<div class='cel_cabecalho'>{$linha['potencia']}</div>";
